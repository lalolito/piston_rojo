...
class Usuario {
    ...
    public function registrarUsuario($tipoDocumento, $numeroDocumento, $nombre, $apellido, $telefono, $direccion, $email, $password, $rol) {
        ...
        $sql = "INSERT INTO Usuario (Usu_Tipo_Documento, Usu_Numero_Documento, Usu_Nombre, Usu_Apellido, Usu_Telefono, Usu_Direccion, Usu_Email, Id_Usupass, Rol_Id_Rol) VALUES (?, ?, ?, ?, ?, ?, ?, (SELECT Id_Usupass FROM Usuario_password WHERE password = ? LIMIT 1), ?)";
